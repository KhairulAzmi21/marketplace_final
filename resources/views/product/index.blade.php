                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($products as $product)
                                <tr>
                                    <td> <a href="/listing/id">{{ $product->title }}</a> </td>
                                    <td> <img src="{{ !is_null($product->image_path) ? asset(str_replace('public','storage', $product->image_path)) : "https://dummyimage.com/400x400/000/fff" }}" width="100px"alt=""> </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="/product/{{$product->id}}/delete" class="btn btn-danger btn-sm btn-delete">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
