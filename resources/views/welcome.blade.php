        ...
        @foreach ($products as $product)
            <div class="col-md-3 mt-4">
                ...
                <div class="card">
                  ...
                  <img src="{{ !is_null($product->image_path) ? asset(str_replace('public','storage', $product->image_path)) : "https://dummyimage.com/400x400/000/fff" }}" class="card-img-top" alt="...">
                  <div class="card-body">
                    ...
                    <a href="/product/{{$product->id}}" class="btn btn-primary">See Details</a>
                  </div>
                </div>
            </div>
        @endforeach
